...
const CONFIG = {
  ...
  serverDomain: "mboxedge35.tt.omtrdc.net"
};
...
//https://adobetarget-sdks.gitbook.io/docs
...
function sendSuccessResponse(res, response) {
  ...
  .replace("{content}", response.content.MboxResponse[0].content);
...
app.get("/abtest", function (req, res) {
  ...
  const payload = {
      mboxes: [{
        //mbox: "app.basket.messaging.returns",
        //mbox: "sephora_global",
        mbox: 'app.pdp.messaging.shipping',
        indexId: 0
      }]
    }
